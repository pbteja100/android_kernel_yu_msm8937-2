...
#define SPI_HW_IRQ_ENABLE               _IOW(SPI_IOC_MAGIC, 80, __u32)
#define SPI_HW_FINGER_STATE_INFO      _IOW(SPI_IOC_MAGIC, 81, __u32)
#define SPI_HW_FINGER_VKEY_RESULT     _IOW(SPI_IOC_MAGIC, 82, __u32)

#define IOCTL_FINGER_STATE_INFO         _IOR(SPI_IOC_MAGIC, 81, __u32)
#define IOCTL_FINGER_VKEY_RESULT        _IOR(SPI_IOC_MAGIC, 82, __u32)
